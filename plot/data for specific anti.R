...
## Load data
# AST 
df <- readRDS("data/clean data/all_each_ast.RData")
...
# Save
saveRDS(pie_result, "data/clean data/pie_specific_anti_ast.RData")
saveRDS(list_long, "data/clean data/bar_specific_anti_ast.RData")
###