...
# Load data
df <- readRDS("data/clean data_V2/readmission_table_index.RData")


# Delete pathogen_combined_types
...
result <- rbind(
  ...
  c("Gram-positive bacteria", NA, NA, NA, NA, NA),
  c("Fungi", NA, NA, NA, NA, NA),
  c("Polymicrobial", NA, NA, NA, NA, NA),
  c("Gram-negative bacteria", NA, NA, NA, NA, NA),
  c("Third-generation cephalosporins-susceptible", NA, NA, NA, "Ref", NA),
  c("Third-generation cephalosporins-resistant", df_used[19, c(2:6)]),
  c("Carbapenem-resistant", df_used[20, c(2:6)]))
...
saveRDS(result_save, "data/clean data_V2/readmission_table_multivariable_2.RData")
###