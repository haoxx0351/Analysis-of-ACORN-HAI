...
# Load data
res1 <- readRDS("data/clean data_V2/readmission_table_univariable.RData")
res2 <- readRDS("data/clean data_V2/readmission_table_multivariable_1.RData")
res3 <- readRDS("data/clean data_V2/readmission_table_multivariable_2.RData")
