...
# Load data
df_data <- readRDS("data/clean_data_RData/anti_treat_index.RData")
df_baseline <- readRDS("data/clean_data_RData/baseline_outcomes_index.RData")
...
# Generate plots
p1 <- generate_sankey(combined_results, c(1, 4), "Carbapenem-resistant Acinetobacter spp.")
