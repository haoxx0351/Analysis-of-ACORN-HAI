...
# Enterobacterales, carbapenem-resistant
# Enterobacterales, third-generation cephalosporin-resistant
car_ent <- organism[which(organism$org_names_all %in% c("E.coli", "Klebsiella pneumoniae", "Klebsiella", "Enterobacter", "Serratia", "Proteus", "Morganella")), c("recordid", "ris_Carbapenems", "ris_Third-generation cephalosporins")] %>%
  group_by(recordid) %>%
