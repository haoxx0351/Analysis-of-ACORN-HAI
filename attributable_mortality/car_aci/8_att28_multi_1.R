...
rows <- list(
  ...
  c("Gastrointestinal disorder", ratio_df[6, c(9:12, 8)]),
  c("Neurological disease", ratio_df[7, c(9:12, 8)]),
  c("Pulmonary disease", ratio_df[8, c(9:12, 8)]),
  c("Trauma", ratio_df[9, c(9:12, 8)]),
  c("Others", ratio_df[10, c(9:12, 8)]),
  c("Charlson comorbidity index", NA, NA, NA, NA, NA),
  c(NA, ratio_df[11, c(9:12, 8)]),
  c("Severity score of disease", NA, NA, NA, NA, NA),
  c(NA, ratio_df[12, c(9:12, 8)]),
  ...
  c("Carbapenem-resistant", ratio_df[13, c(9:12, 8)]))
