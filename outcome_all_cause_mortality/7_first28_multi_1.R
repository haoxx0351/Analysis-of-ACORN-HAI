...
# MODEL delete comorbidities_Chalson
...
rows <- list(
  ...
  c("Polymicrobial", ratio_df[19, c(5:7, 12, 8)]),
  c("Gram-negative bacteria", NA, NA, NA, NA, NA),
  c("Third-generation cephalosporins-susceptible", NA, NA, NA, "Ref", NA),
  c("Third-generation cephalosporins-resistant", ratio_df[20, c(5:7, 12, 8)]),
  c("Carbapenem-resistant", ratio_df[21, c(5:7, 12, 8)])
)
...
saveRDS(result_save, "data/frist28_table_multi_1.RData")
