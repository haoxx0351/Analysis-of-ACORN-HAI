...
rows <- list(
  ...
  c("Pulmonary disease", ratio_df[13, c(5:8, 1)]),
  c("Renal disorder", ratio_df[14, c(5:8, 1)]),
  c("Trauma", ratio_df[15, c(5:8, 1)]),
  c("Others", ratio_df[16, c(5:8, 1)]),
  ...
  c("Yes", ratio_df[19, c(5:8, 1)]),
  c("Type of pathogens", NA, NA, NA, NA, NA),
  c("Monomicrobial", NA, NA, NA, "Ref", NA),
  c("Polymicrobial", ratio_df[20, c(5:8, 1)]),
  c("Gram-negative bacteria", NA, NA, NA, NA, NA),
  c("Third-generation cephalosporins-susceptible", NA, NA, NA, "Ref", NA),
  c("Third-generation cephalosporins-resistant", ratio_df[21, c(5:8, 1)]),
  c("Carbapenem-resistant", ratio_df[22, c(5:8, 1)])
 )
...
saveRDS(result_save, "data/frist28_table_univariable.RData")