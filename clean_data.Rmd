...
org_names <- c("E. coli", "K. pneumoniae", "Acinetobacter", "Pseudomonas",
...
gnb_list <- c("K. pneumoniae", "Pseudomonas", "E. coli", "Acinetobacter",
...
# "E. coli", "K. pneumoniae","Acinetobacter", "Pseudomonas",
# "Serratia/Proteus/Morganella/Enterobacter"
...
anti_treat_index_new <- anti_treat_index_new %>%
  mutate(contains_aci = ifelse(str_detect(org_combined, "Acinetobacter"), 1, 0),
         contains_ent = ifelse(str_detect(org_combined, "E. coli|K. pneumoniae|Klebsiella|Enterobacter|Serratia|Proteus|Morganella"), 1, 0),
...
id_ent_thir_index_r <- all_ast_merged_index$recordid[which((all_ast_merged_index$`ris_Third-generation cephalosporins` %in% c(1,2)) & (all_ast_merged_index$org_names_all %in% c("E. coli", "K. pneumoniae", "Klebsiella", "Enterobacter", "Serratia", "Proteus", "Morganella")))]
id_ent_thir_index_s <- all_ast_merged_index$recordid[which((all_ast_merged_index$`ris_Third-generation cephalosporins` == 3) & (all_ast_merged_index$org_names_all %in% c("E. coli", "K. pneumoniae", "Klebsiella", "Enterobacter", "Serratia", "Proteus", "Morganella")))]

id_ent_car_index_r <- all_ast_merged_index$recordid[which((all_ast_merged_index$ris_Carbapenems %in% c(1,2)) & (all_ast_merged_index$org_names_all %in% c("E. coli", "K. pneumoniae", "Klebsiella", "Enterobacter", "Serratia", "Proteus", "Morganella")))]
id_ent_car_index_s <- all_ast_merged_index$recordid[which((all_ast_merged_index$ris_Carbapenems == 3) & (all_ast_merged_index$org_names_all %in% c("E. coli", "K. pneumoniae", "Klebsiella", "Enterobacter", "Serratia", "Proteus", "Morganella")))]
...
id_kle_car_index_r <- all_ast_merged_index$recordid[which((all_ast_merged_index$ris_Carbapenems %in% c(1,2)) & (all_ast_merged_index$org_names == "K. pneumoniae"))]
id_kle_car_index_s <- all_ast_merged_index$recordid[which((all_ast_merged_index$ris_Carbapenems == 3) & (all_ast_merged_index$org_names == "K. pneumoniae"))]
