...
result <- rbind(
  ...
  c("Gastrointestinal disorder", df_used[8, c(2:6)]),
  c("Haematological disease", df_used[9, c(2:6)]),
  c("Neurological disease", df_used[10, c(2:6)]),
  c("Oncologic disorder", df_used[11, c(2:6)]),
  c("Pulmonary disease", df_used[12, c(2:6)]),
  c("Renal disorder", df_used[13, c(2:6)]),
  c("Trauma", df_used[14, c(2:6)]),
  c("Others", df_used[15, c(2:6)]),
  c("Charlson comorbidity index", NA, NA, NA, NA, NA),
  c(NA, NA, NA, NA, NA, NA),
  c("Severity score of disease", NA, NA, NA, NA, NA),
  c(NA, df_used[21, c(2:6)]),
  c("ICU/HD admissions of enrolment", NA, NA, NA, NA, NA),
  c("No", NA, NA, NA, "Ref", NA),
  c("Yes", df_used[16, c(2:6)]),
  c("Type of pathogens", NA, NA, NA, NA, NA),
  c("Monomicrobial", NA, NA, NA, "Ref", NA),
  c("Polymicrobial", df_used[17, c(2:6)]),
  c("Gram-negative bacteria", NA, NA, NA, NA, NA),
  c("Third-generation cephalosporins-susceptible", NA, NA, NA, "Ref", NA),
  c("Third-generation cephalosporins-resistant", df_used[18, c(2:6)]),
  c("Carbapenem-resistant", df_used[19, c(2:6)]))
