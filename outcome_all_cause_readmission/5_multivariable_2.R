...
# Delete pathogen_combined_types, icu_hd_ap
...
result <- rbind(
  ...
  c("Third-generation cephalosporins-resistant", df_used[16, c(2:6)]),
  c("Carbapenem-resistant", df_used[17, c(2:6)]))
