...
rows <- list(
  ...
  c("Haematological disease", ratio_df[8, c(9:12, 8)]),
  c("Neurological disease", ratio_df[9, c(9:12, 8)]),
  c("Oncologic disorder", ratio_df[10, c(9:12, 8)]),
  c("Orthopaedic condition", ratio_df[11, c(9:12, 8)]),
  ...
  c("Third-generation cephalosporin-resistant", ratio_df[19, c(9:12, 8)]))
...
saveRDS(result_save, "data/att28_table_multi_2.RData")
saveRDS(df, "data/3GCRE_data.RData")