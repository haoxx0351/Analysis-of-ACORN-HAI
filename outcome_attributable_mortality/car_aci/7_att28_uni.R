...
rows <- list(
  ...
  c("Gastrointestinal disorder", ratio_df[8, c(5:8, 1)]),
  c("Neurological disease", ratio_df[9, c(5:8, 1)]),
  c("Pulmonary disease", ratio_df[10, c(5:8, 1)]),
  c("Trauma", ratio_df[11, c(5:8, 1)]),
  c("Others", ratio_df[12, c(5:8, 1)]),
  c("Charlson comorbidity index", NA, NA, NA, NA, NA),
  c(NA, ratio_df[13, c(5:8, 1)]),
  c("Severity score of disease", NA, NA, NA, NA, NA),
  c(NA, ratio_df[14, c(5:8, 1)]),
  c("ICU/HD admissions of enrolment", NA, NA, NA, NA, NA),
  c("No", NA, NA, NA, "Ref", NA),
  c("Yes", ratio_df[15, c(5:8, 1)]),
  c("Types of pathogens", NA, NA, NA, NA, NA),
  c("Monomicrobial", NA, NA, NA, "Ref", NA),
  c("Polymicrobial", ratio_df[16, c(5:8, 1)]),
  c("Acinetobacter", NA, NA, NA, NA, NA),
  c("Carbapenem-susceptible", NA, NA, NA, "Ref", NA),
  c("Carbapenem-resistant", ratio_df[17, c(5:8, 1)])
)
