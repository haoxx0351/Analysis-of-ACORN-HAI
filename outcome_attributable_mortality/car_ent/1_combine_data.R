...
# Enterobacterales, carbapenem-resistant
car_ent <- organism[which(organism$org_names_all %in% c("E. coli", "K. pneumoniae", "Klebsiella", "Enterobacter", "Serratia", "Proteus", "Morganella")), c("recordid", "ris_Carbapenems")]
...
# Enterobacterales, third-generation cephalosporin-resistant
thir_ceph_ent <- organism[which(organism$org_names_all %in% c("E. coli", "K. pneumoniae", "Klebsiella", "Enterobacter", "Serratia", "Proteus", "Morganella")), c("recordid", "ris_Third-generation cephalosporins")]
...
process_dataframe <- function(df) {
  ...
  small_levels <- names(which(table(df$hpd_admreason) <= 20))
