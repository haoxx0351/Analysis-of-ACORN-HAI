...
# MODEL 2
# Delete hpd_admreason, pathogen_combined_types
...
rows <- list(
  ...
  c("Haematological disease", NA, NA, NA, NA, NA),
  c("Neurological disease", NA, NA, NA, NA, NA),
  c("Oncologic disorder", NA, NA, NA, NA, NA),
  c("Orthopaedic condition", NA, NA, NA, NA, NA),
  ...
  c("Carbapenem-resistant", ratio_df[10, c(9:12, 8)]))
